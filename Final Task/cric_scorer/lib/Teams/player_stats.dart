...
import 'package:cric_scorer/Teams/create_player.dart';
import 'package:cric_scorer/Teams/popup.dart';
...
// Fielding Stats
  ...
  Future<void> _delete_player() async {
    return FirebaseFirestore.instance
      ...
      FirebaseStorage.instance.refFromURL(player_args[0]['img_url']).delete() : null;
      setState(() {
          inprogress = false;
        });
      ...
      () async {
        ...
        await FirebaseFirestore.instance
          ...
          querysnap.docs.forEach((doc) {
            team1player_names.add(doc['team_details']['team1_players_ids'][player_args[0]['player_name']]);
            team1player_names.add(doc['team_details']['team2_players_ids'][player_args[0]['player_name']]);
          });
        });
        if (team1player_names.contains(player_args[0]['player_id'].toString())) {
          customtoast(
