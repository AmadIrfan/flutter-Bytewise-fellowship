  ...
  Future<void> _fetch_players_data() async {
    return FirebaseFirestore.instance
      ...
      qsnap.docs.forEach((doc) {
        ...
        if(match_info_box.read('selected_status' + args['team_name']) == null){
        selected_players[doc['player_name']] = false;
        }else{
          Map players_status = match_info_box.read('selected_status' + args['team_name']);
            ...
            child: IconButton(
              onPressed: () {
                if (selected_players_true_val.length < 2) {
                  ...
                  match_info_box.write(args['team_name']+'players', selected_players_true_val.keys.toList());
                  match_info_box.write('selected_status' + args['team_name'], selected_players);
                  selected_players_true_val.forEach((plkey, plvalue) {
                    match_info_box.write(args['team_name'].toString()+'$plkey',  {
                      ...
                      var id = match_info_box.read(args['team_name'].toString()+'$plkey')['player_id'];
                      print('player_id : $id');
                    });
                  });
                  Get.back();
                          ...
                          setState(() {
                            ...
                            if (selected_players[all_players[index]
                              ...
                              selected_players_true_val[all_players[index]
                                ...
                                'player_id': all_players[index]['player_id'],
                              };
                            } else {
                              selected_players_true_val
                                  .remove(all_players[index]['player_name']);
                            }
                          });
