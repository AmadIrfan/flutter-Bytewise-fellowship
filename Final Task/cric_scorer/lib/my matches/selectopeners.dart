...
import 'package:cric_scorer/my%20matches/select_openers_player.dart';
import 'package:cric_scorer/my%20matches/select_player.dart';
...
class _select_openersState extends State<select_openers> {
  ...
  Future<void> savetodatabase() async {
    ...
    for (var player_name in team1players_names) {
     inning ? team1players_ids[player_name.toString()] = match_info_box
          .read(team1info['team_name'] + player_name.toString())['player_id'] : {};
    }
    for (var player_name in team2players_names) {
      inning ?
      team2players_ids[player_name.toString()] = match_info_box
          .read(team2info['team_name'] + player_name.toString())['player_id'] : {};
    }
                              ...
                              savetodatabase().then((value) {
                                args['inning_no'] == 'inning1'
                                    ...
                                    : setState(() {
                                        ...
                                        args['inning_no'] == 'inning1' ?
                                        customtoast('Match Created') : customtoast('Inning 2 created'); 
                                      });
                              });
                            } else {
