...
import 'package:cric_scorer/my%20matches/custom_button.dart';
import 'package:cric_scorer/login_singup/login_page.dart';
import 'package:cric_scorer/Scoring%20Page/match_settings.dart';
import 'package:cric_scorer/my%20matches/selectopeners.dart';
import 'package:cric_scorer/my%20matches/virtual_coin.dart';
// import 'package:cricket_scorer/toss_coin.dart';
                    ...
                    if(_isSelectedTeam != 0){
                      if(_selectedRadio != 0){
                        ...
                        match_info_box.write('toss', {
                          ...
                          Get.to(() => select_openers(),transition: Transition.rightToLeft,
                          arguments: {
                            'inning_no' : 'inning1',
                            'match_id' : '',
                            'team1_id' : '',
