...
import 'package:cric_scorer/my matches/match_details.dart';
import 'package:cric_scorer/my%20matches/select_player.dart';
import 'package:cric_scorer/my%20matches/select_team.dart';
                ...
                Padding(
                  ...
                  child: customteamcontainer(
                    team2img.isNotEmpty
                        ? CircleAvatar(
                            radius: 50,
                            foregroundImage: CachedNetworkImageProvider(team2img),
                            backgroundColor: Colors.grey[200],
                            child: Icon(
                              FontAwesomeIcons.users,
                              color: Colors.grey[800],
