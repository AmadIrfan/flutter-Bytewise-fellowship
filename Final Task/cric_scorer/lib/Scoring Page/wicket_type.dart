...
import 'package:cric_scorer/Scoring%20Page/batsman_selection.dart';
import 'package:cric_scorer/Scoring%20Page/matchcentretab.dart';
import 'package:cric_scorer/customdialog.dart';
  ...
  Future<void> out_player_functionality(wicket_type, {isallout = false}) async {
    ...
    await FirebaseFirestore.instance
      ...
      FirebaseFirestore.instance
        ...
        striker.toString(): 
        player_info_box.read('isselected') ?
        {  
        ...
        _isCrossed ? ds['striker_name'] : player_info_box.read('player')['player_name']
        :
        ds['striker_name']
        ,
        'over': this_over,
        'oversdata': {
         ...
         'Bowler': {
            ...
            'economy_rate': _calculate_economy_rate(
                    ds['Bowler']['runs'] + (_wideChecked || _noBallChecked
                        ? (int.parse(_runsScored.text) + 1)
                        : int.parse(_runsScored.text)),
                    bowler_overs)
                .toPrecision(1),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (player_info_box.read('isselected') || notout_batters == 0) {
                            if (widget.wicketType == 1) {
                              out_player_functionality(1, isallout: notout_batters == 0 ? true: false);
                            } else if (widget.wicketType == 2) {
                              if (_selectedFielder == "Select Fielder") {
                                customtoast('Select Fielder');
                              } else {
                                out_player_functionality(2, isallout: notout_batters == 0 ? true: false);
                              }
                            } else if (widget.wicketType == 4) {
                              if (_selectedFielder == "Select Fielder") {
                                customtoast('Select Fielder');
                              } else {
                                out_player_functionality(4, isallout: notout_batters == 0 ? true: false);
                              }
                              ...
                              if (_selectedFielder == "Select Fielder") {
                                ...
                                out_player_functionality(5, isallout: notout_batters == 0 ? true: false);
                              }
                            } else if (widget.wicketType == 6) {
                              out_player_functionality(6, isallout: notout_batters == 0 ? true: false);
                            } else if (widget.wicketType == 7) {
                              out_player_functionality(7, isallout: notout_batters == 0 ? true: false);
                            } else if (widget.wicketType == 10) {
                              if (_selectedOutBatsman == "Select Out Batsman") {
                                customtoast('Select Out Batsman');
                              }else{
                              out_player_functionality(10, isallout: notout_batters == 0 ? true: false);
                              }
                            }
                          } else {
