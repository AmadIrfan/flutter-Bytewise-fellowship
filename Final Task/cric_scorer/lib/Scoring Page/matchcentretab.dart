// import 'package:cric_scorer/Scoring%20Page/dialog.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:cric_scorer/Scoring%20Page/player_out.dart';
import 'package:cric_scorer/Scoring%20Page/player_selection.dart';
import 'package:cric_scorer/customdialog.dart';
import 'package:cric_scorer/my%20matches/selectopeners.dart';
           ...
           if(match_result != 'Match Drawn'){
            ...
            .then((QuerySnapshot query) {
              ...
              if(doc['team_name']  == winner_team){
                ...
                winner_team_played_matches = (doc['stats']['played'] + 1).toString();
              }else if (doc['team_name'] == loser_team){
                loser_team_won_matches = (doc['stats']['won']).toString();
                loser_team_played_matches = (doc['stats']['played'] + 1).toString();
              }
              });
            });
            ds['isended'] ?
            null:
              await _teams.doc(winner_team_id).set({
                'stats' : {
                  ...
                  'win_percentage' : _win_percentage_calculator(double.parse(winner_team_won_matches), double.parse(winner_team_played_matches)).toInt(),
                }
            ...
            ds['isended'] ?
              ...
              await _teams.doc(loser_team_id).set({
                'stats' : {
                  ...
                  'played' : FieldValue.increment(1),
                  'win_percentage' : _win_percentage_calculator(double.parse(loser_team_won_matches), double.parse(loser_team_played_matches)).toInt(),
                }
              }, SetOptions(merge: true));
           }else{
             await _teams
      ...
      builder:
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          args['inning_no'] == 'inning2' && data!['isended'] ||
                  ...
                  data['Total']['total_score'] >= data['target']// && data['result'].isBlank
              ? result_func()
              : null;
