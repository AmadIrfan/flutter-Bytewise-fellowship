                  ...
                  builder: (context, players_snapshot) {
                    ...
                    players_snapshot.data?.docs.forEach((doc) {
                      if(doc['team_name'] == ds!['batting_team']){
                        if(doc['batting']['total_runs'] > 0 || doc['batting']['total_balls'] > 0){
                          batter_row.add(
                            TableRow(
                              decoration: BoxDecoration(
                                color: Colors.white,
                              ...
                              children: [
                                ...
                                _customtext(doc['batting']['total_runs'].toString()),
                                _customtext(
                                    doc['batting']['total_balls'].toString()),
                                _customtext(doc['batting']['fours'].toString()),
                                _customtext(doc['batting']['sixes'].toString()),
                                _customtext(
                        ...
                        if(int.parse(doc['bowling']['overs'].toString().split('.')[0]) > 0 ||
                        int.parse(doc['bowling']['overs'].toString().split('.')[1]) > 0
                        ){
                          bowler_row.add(
                             TableRow(
                              decoration: BoxDecoration(
                              ...
                              children: [
                                ...
                                _customtext(doc['bowling']['overs'].toString()),
                                _customtext(doc['bowling']['maiden'].toString()),
                                _customtext(doc['bowling']['runs'].toString()),
                                _customtext(doc['bowling']['wickets'].toString()),
                                _customtext(doc['bowling']['economy_rate'].toString()),
                              ],
                            ),
                          );
                        }
                    ...
                    if(players_snapshot.connectionState == ConnectionState.waiting){
                      return Padding(
                      ...
                      title: _customtext(ds['Total']['total_score'].toString() +
                          '/' +
